...
public class Pankreas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pankreas);
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_pankreas);
        String[] arPenyakit = resources.getStringArray(R.array.arti_pankreas);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_pankreas);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_pankreas);
