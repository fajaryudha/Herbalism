...
public class Jantung extends AppCompatActivity {
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_jantung);
        String[] arPenyakit = resources.getStringArray(R.array.arti_jantung);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_jantung);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_jantung);
        ...
        for (int i = 0; i < arJudul.length; i++) {
            ...
            for (int j = 0; j < arPenyakit.length - 3; j++) {
