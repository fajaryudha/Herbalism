...
public class Ginjal extends AppCompatActivity {
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_ginjal);
        String[] arPenyakit = resources.getStringArray(R.array.arti_ginjal);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_ginjal);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_ginjal);
