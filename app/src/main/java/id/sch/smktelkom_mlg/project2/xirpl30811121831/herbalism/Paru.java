...
public class Paru extends AppCompatActivity {
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_paru);
        String[] arPenyakit = resources.getStringArray(R.array.arti_paru);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_paru);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_paru);
