...
public class Mata extends AppCompatActivity {
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_mata);
        String[] arPenyakit = resources.getStringArray(R.array.arti_mata);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_mata);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_mata);
