...
public class Hati extends AppCompatActivity {
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_hati);
        String[] arPenyakit = resources.getStringArray(R.array.arti_hati);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_hati);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_hati);
