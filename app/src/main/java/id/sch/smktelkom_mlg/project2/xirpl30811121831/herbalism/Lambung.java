...
public class Lambung extends AppCompatActivity {
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_lambung);
        String[] arPenyakit = resources.getStringArray(R.array.arti_lambung);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_lambung);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_lambung);
