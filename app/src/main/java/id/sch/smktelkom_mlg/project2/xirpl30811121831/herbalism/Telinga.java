...
public class Telinga extends AppCompatActivity {
    ...
    private List<ParentObject> initData() {
        ...
        String[] arJudul = resources.getStringArray(R.array.penyakit_telinga);
        String[] arPenyakit = resources.getStringArray(R.array.arti_telinga);
        String[] arPenyakit1 = resources.getStringArray(R.array.obat_telinga);
        TypedArray a = resources.obtainTypedArray(R.array.sebab_telinga);
